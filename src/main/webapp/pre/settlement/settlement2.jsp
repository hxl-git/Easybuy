    ...
    <div class="two_bg">
        ...
        <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="395">${sessionScope.easybuyUserLogin.userName}</td>
                <td class="p_td">登录名称</td>
                <td>${sessionScope.easybuyUserLogin.loginName}</td>
            </tr>
            <tr>
                <td class="p_td">手机</td>
                <td>${sessionScope.easybuyUserLogin.mobile}</td>
                <td class="p_td" width="160">电子邮件</td>
                <td width="395">${sessionScope.easybuyUserLogin.email}</td>
            </tr>
        </table>
        <div class="two_t">
            ...
            <c:forEach items="${userAddressList}" var="temp" varStatus="status">
                <tr>
                    <td class="p_td" width="160">
                        ...
                        <c:if test="${temp.isDefault==1}">
                        <input type="radio" name="selectAddress" checked="checked" value="${temp.id}">
                        </c:if>   
                        <c:if test="${temp.isDefault==0}">
