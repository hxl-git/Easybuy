                ...
                <ul class="cate_list">
                    <c:forEach items="${productList}" var="productList">
                        <li>
                            ...
                            <div class="name"><a href="${ctx}/queryProductDeatil.html.a?id=${productList.id}">${productList.name}</a></div>
                            <div class="carbg">
                            ...
                            <c:otherwise>
                            <a href="javascript:void(0);" class="ss" style="background-image: url(${ctx}/statics/images/heart_h.png)" onclick="addFavoriteDeatil(this,'${productList.id}')">收藏</a>
                            </c:otherwise>
                            </c:choose>                  
...
function clickimg(id) {
	location.href = contextPath+"/queryProductDeatil.html.a?id="+id;
}
